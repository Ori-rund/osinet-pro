...
# ו"נפגעים" מתארים באותה מידה מחבל שתקף ישראלי, או מחבל פלסטיני
# שנהרג בתקיפה שלנו בעזה. ההבדל הוא מי הנושא ומי המושא — בדיוק מה
...
_WEAK_IMPACT = {"מחבל", "מחבלים", "הותקף", "נורה למוות", "חיסול", "נפגעים"}
